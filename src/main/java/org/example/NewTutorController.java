...
public class NewTutorController {
    ...
    public TextField ntAlumnTxtBox;
        ...
        ntTutorTable.setRowFactory(rowClick -> {
            ...
            row.setOnMouseClicked(event -> {
                if (!row.isEmpty() && event.getButton() == MouseButton.PRIMARY && event.getClickCount() == 2) {
                    ...
                    ntAlumnTxtBox.setText(clickedRow.getStudent());
    ...
    public void SaveBtn(ActionEvent actionEvent) {
        ...
        if (exists == false) {
            App.tutors.add(new Tutor(ntNameTxtBox.getText(), ntSchoolTxtBox.getText(), ntAlumnTxtBox.getText(), Integer.parseInt(ntGradeTxtBox.getText()), Integer.parseInt(ntAgeTxtBox.getText()), Integer.parseInt(ntSessionsTxtBox.getText())));
        }
